...
from tensorflow.keras.layers import Conv2D,Input,Dense,Lambda
from tensorflow.keras.layers import MaxPooling2D,Activation
from tensorflow.keras.layers import Flatten,Concatenate,Dropout,Reshape
...
if __name__ == "__main__":
   ...
   #     print(temp)
        ...
        global_path = DATA_PATH+'/simulation_data3.0/overall/' + str(i) + '.jpg'
   ...
   # zero_index = []
    ...
    print(len(depth_in),len(poses_in),len(dofs_in),len(qualities_out),len(global_in))
  ...
  #  print(img_out.shape)
    ...
    print('rgbd_config_concat.shape:',rgbd_config_concat.shape)
