...
float64 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.Struct(pattern).pack(*self.result.energies))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.result.energies = s.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.result.search_energy = str[start:end].decode('utf-8', 'rosmsg')
      else:
