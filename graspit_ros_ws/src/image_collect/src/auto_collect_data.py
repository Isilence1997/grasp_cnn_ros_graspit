...
def rgb_callback(data,args):
    ...
    file_path = '/home/hhy/simulation_data3.0/rgb/'+args+'.jpg'
...
def depth_callback(data,args):
    ...
    file_path = '/home/hhy/simulation_data3.0/depth/'+args+'.jpg'
...
def load_model(num,name):
    #加载模型文件
    file_path = '/home/hhy/simulation_data3.0/gazebo_data/sdf_file/o'+num+'.sdf'
    #name = '"model"'
